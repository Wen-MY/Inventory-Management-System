    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{ route('changeUsername') }}" method="post" class="form-horizontal" id="changeUsernameForm">
                    <fieldset>
                ...
                <form action="{{ route('changePassword') }}" method="post" class="form-horizontal" id="changePasswordForm">
                    <fieldset>
